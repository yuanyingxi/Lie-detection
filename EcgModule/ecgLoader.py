...
class EcgLoader:
    def __init__(self, ecg_path, timeStamp_path, Label_path, target_fps, static_target_len, trial_target_len):
    ...
    def rectifyLength(self, ecgdata):
        target_Length = (self.static_target_len + self.trial_target_len) * self.target_fps
        # 如果长度过长，截取
